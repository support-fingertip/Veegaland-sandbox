({
    doInit : function(component, event, helper) {
        ...
        console.log('Send button clicked, sending Apex call...');
        ...
        action.setCallback(this,function(a){           
            ...
            let url;
            url = baseUrl+'/apex/VeegalandReceipt?Id='+component.get("v.recordId");
    ...
    send: function(component, event, helper) {
        ...
        var action = component.get("c.sendEmailVeegalandReceipt");
