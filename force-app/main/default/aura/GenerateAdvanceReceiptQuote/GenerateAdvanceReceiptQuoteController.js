({
    doInit : function(component, event, helper) {
        let baseUrl = window.location.origin;
            let url;
            url = baseUrl+'/apex/AdvanceReceiptQuote?Id='+component.get("v.recordId");
            component.set("v.vfPageUrl", url);
        
        
    },
      send: function(component, event, helper) {
        // Call the Apex method 'sendAdvanceAmountReceipt'
        var action = component.get("c.sendAdvanceAmountReceipt");
